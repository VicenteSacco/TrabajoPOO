   ...
   private void iniciarComponentesVentana(){
       ...
       ActionListener evento = new ActionListener() {
           ...
           public void actionPerformed(ActionEvent e) {
               ...
               com.mycompany.trabajo.Ventanas.Persona persona = new com.mycompany.trabajo.Ventanas.Persona(nombre,peso2,altura2);
               System.out.println(persona.getNombre());
               System.out.println(persona.getPeso());
               System.out.println(persona.getAltura());
                com.mycompany.trabajo.Ventanas.VentanaOpciones ventana2 = new com.mycompany.trabajo.Ventanas.VentanaOpciones();
